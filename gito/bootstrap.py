"""Bootstrap module for initializing the CodeRubric application environment."""
import os
import sys
import io
import logging
...
def bootstrap(verbosity: int = 1):
    ...
    logging.info(
        f"Bootstrapping CodeRubric v{Env.gito_version}... " + mc.ui.gray(f"[verbosity={verbosity}]")
    )
    ...
    try:
        ...
        if is_running_in_github_action():
            ...
            msg += (
                ...
                f"See https://github.com/Sushant/CodeRubric/blob/main/documentation/github_setup.md "
                f"for details."
            )
