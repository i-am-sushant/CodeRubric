# <a href="https://github.com/Sushant/CodeRubric"><img src="https://raw.githubusercontent.com/Sushant/CodeRubric/main/press-kit/logo/gito-bot-1_64top.png" align="left" width=64 height=50 title="CodeRubric: AI Code Reviewer"></a>GitHub Setup Guide: Integrating CodeRubric with Your Repository

Automate code review for all Pull Requests using AI.  
This step-by-step guide shows how to connect [CodeRubric](https://pypi.org/project/coderubric/) to a GitHub repository for **continuous, automated PR reviews**.
...
- Create a `.gito/config.toml` file at your repository root to override [default configuration](https://github.com/Sushant/CodeRubric/blob/main/gito/config.toml).
...
- For help or bug reports, [open an issue](https://github.com/Sushant/CodeRubric/issues)
