...
DefaultDirName={autopf}\CodeRubric
DefaultGroupName=CodeRubric
AllowNoIcons=yes
LicenseFile=LICENSE
...
[Icons]
Name: "{group}\CodeRubric AI Code Reviewer"; Filename: "{app}\{#MyAppExeName}"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\CodeRubric AI Code Reviewer"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon
