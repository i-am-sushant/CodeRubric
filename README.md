<h1 align="center"><a href="#"><img alt="CodeRubric: AI Code Reviewer" src="https://raw.githubusercontent.com/Sushant/CodeRubric/main/press-kit/logo/gito-ai-code-reviewer_logo-180.png" align="center" width="180"></a></h1>
<p align="center">
<a href="https://pypi.org/project/gito.bot/" target="_blank"><img src="https://img.shields.io/pypi/v/gito.bot" alt="PYPI Release"></a>
<a href="https://github.com/Sushant/CodeRubric/actions/workflows/code-style.yml" target="_blank"><img src="https://github.com/Sushant/CodeRubric/actions/workflows/code-style.yml/badge.svg" alt="PyLint"></a>
<a href="https://github.com/Sushant/CodeRubric/actions/workflows/tests.yml" target="_blank"><img src="https://github.com/Sushant/CodeRubric/actions/workflows/tests.yml/badge.svg" alt="Tests"></a>
<img src="https://raw.githubusercontent.com/Sushant/CodeRubric/main/coverage.svg" alt="Code Coverage">
...
<a href="https://github.com/Sushant/CodeRubric/blob/main/LICENSE" target="_blank"><img src="https://img.shields.io/static/v1?label=license&message=MIT&color=d08aff" alt="License"></a>
</p>
...
- [Guides & Reference](#-guides--reference)
  - [Command Line Reference](https://github.com/Sushant/CodeRubric/blob/main/documentation/command_line_reference.md) ↗
  - [Configuration Cookbook](https://github.com/Sushant/CodeRubric/blob/main/documentation/config_cookbook.md) ↗
  - [GitHub Setup Guide](https://github.com/Sushant/CodeRubric/blob/main/documentation/github_setup.md) ↗
  - Integrations
    - [Linear Integration](https://github.com/Sushant/CodeRubric/blob/main/documentation/linear_integration.md) ↗ 
    - [Atlassian Jira Integration](https://github.com/Sushant/CodeRubric/blob/main/documentation/jira_integration.md) ↗
  - [Troubleshooting](https://github.com/Sushant/CodeRubric/blob/main/documentation/troubleshooting.md) ↗
  - [Documentation generation with CodeRubric](https://github.com/Sushant/CodeRubric/blob/main/documentation/documentation_generation.md) ↗
- [Known Limitations](#-known-limitations)
- [Development Setup](#-development-setup)
- [Contributing](#-contributing)
- [License](#-license)

## ✨ Why CodeRubric?<a id="-why-coderubric"></a>
...
✨ See [code review in action](https://github.com/Sushant/CodeRubric/pull/99) ✨
...
> ℹ️ CodeRubric ships ready-to-use CI/CD workflows for these platforms, 
> with full support for triggering actions via PR comments, automatic review posting, and PR lifecycle integration.  
> 
> Not on this list? CodeRubric works anywhere—via custom CI/CD pipelines or directly from the CLI.
...
|--------|---------------|---------------|
| Jira   | ✅ Supported  | [Atlassian Jira Integration](https://github.com/Sushant/CodeRubric/blob/main/documentation/jira_integration.md) ↗ |
| Linear | ✅ Supported  | [Linear Integration](https://github.com/Sushant/CodeRubric/blob/main/documentation/linear_integration.md) ↗ |

> 🚀 More platforms and integrations are coming — CodeRubric is built to grow with your stack.

## 🔒 Security & Privacy<a id="-security--privacy"></a>

CodeRubric keeps your source code private by design:
...
See [GitHub Setup Guide](https://github.com/Sushant/CodeRubric/blob/main/documentation/github_setup.md) for more details.
...
**Step 1:** Install [gito.bot](https://github.com/Sushant/CodeRubric) using [pip](https://en.wikipedia.org/wiki/Pip_(package_manager)).
```bash
...
```bash
pip install git+https://github.com/Sushant/CodeRubric.git@<branch-or-tag>
```
#### Option B: Windows Standalone Installer

Download the latest Windows installer from [Releases](https://github.com/Sushant/CodeRubric/releases).
...
**Bundled Defaults** ([config.toml](https://github.com/Sushant/CodeRubric/blob/main/gito/config.toml)) → **Project Config** (`<your-repo>/.gito/config.toml`)
...
Explore the bundled [config.toml](https://github.com/Sushant/CodeRubric/blob/main/gito/config.toml) for the complete list of available options.
...
For detailed guidance, see the [📖 Configuration Cookbook](https://github.com/Sushant/CodeRubric/blob/main/documentation/config_cookbook.md).
...
Or browse all documentation in the [`/documentation`](https://github.com/Sushant/CodeRubric/tree/main/documentation) directory.


## 🚧 Known Limitations<a id="-known-limitations"></a>

CodeRubric cannot modify files inside `.github/workflows` when reacting to GitHub PR comments (e.g., "CodeRubric fix issue 2").  
...
<div><img align="right" width="460" src="https://raw.githubusercontent.com/Sushant/CodeRubric/4_0_1/press-kit/character/gito_fullbody_1.jpg">
...
> `pip install -e ".[dev]"`  
> See the [Makefile](https://github.com/Sushant/CodeRubric/blob/main/Makefile) for all available commands.
...
See [CONTRIBUTING.md](https://github.com/Sushant/CodeRubric/blob/main/CONTRIBUTING.md) for details.

## 📝 License<a id="-license"></a>

Licensed under the [MIT License](https://github.com/Sushant/CodeRubric/blob/main/LICENSE).
